          ...
          <div className="flex items-center space-x-6">
            ...
            <div>
              <h1 className="text-3xl font-bold">
                {userProfile?.display_name || currentUser?.displayName || 'User Profile'}
              </h1>
              <p className="text-white/80 text-lg">
                {currentUser?.email}
              </p>
              <div className="flex items-center space-x-2 mt-2">
                <span className="text-sm">{getProviderIcon(userProfile?.provider || 'email')}</span>
                <span className="text-white/70 text-sm capitalize">
                  {userProfile?.provider?.replace('.com', '') || 'Email'} Account
                </span>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-2">
                ...
                {isEditing ? (
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                    <User className="w-5 h-5 text-gray-400" />
                    <span className="font-medium text-gray-800">
                      {userProfile?.display_name || currentUser?.displayName || 'Not set'}
                    </span>
                  </div>
                )}
              </div>
            ...
            {isEditing && (
              <div className="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-200">
                ...
                <button
                  ...
                  className="flex items-center space-x-2 bg-primary text-white px-6 py-2 rounded-lg hover:bg-primary/90 transition-all"
                >
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 capitalize">
                      {userProfile?.provider?.replace('.com', '') || 'Email'} Authentication
                    </p>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-md">
            ...
            <div className="flex space-x-3 mt-6 pt-4 border-t border-gray-200">
              <button
                ...
                className="flex items-center space-x-2 flex-1 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-all"
              >
