...
const EditWarehouseModal: React.FC<EditWarehouseModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    setError('');
    showToast('loading', 'Updating warehouse...');
    ...
    try {
      ...
      showToast('error', err.message || 'Failed to update warehouse');
    } finally {
      setIsLoading(false);
    }
  };
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <div className="flex items-start space-x-2">
                ...
                <div className="text-sm text-blue-800">
                  <p className="font-medium mb-1">Warehouse ID: {warehouse.id}</p>
                  <p>Warehouse ID cannot be changed after creation.</p>
                </div>
              </div>
            </div>
